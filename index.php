        ...
        <section class="box-5">
            <div id="counter_block" class="row">
                ...
                <div class="counter_button text-center">
                    <a class=" btn-shadow w-100 flex text-white">Get started now</a>
                </div>
            </div>
        ...
        <section class="box-7">
            ...
            <div class="pretable">
                ...
                <div class="footer_table flex text-center">
                    <a href="" class="px-25 flex gap-3 btn-shadow text-white"> <img class="h-4"
                    ...
                    <div class="flex our_advantages">
                        ...
                        <div class="flex items-center from_any_device">
                            <div>
                                ...
                                <a href="" class="btn w-52 flex justify-center">Sign Up Now</a>
                            </div>
                        </div>
                    </div>
                </div>
