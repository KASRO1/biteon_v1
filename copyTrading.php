  ...
  <main class="mb-96 p-0">
    ...
    <section class="top_tradersROI p-10">
      ...
      <div class="reviews-box__slider ">
        <swiper-container class="mySwiper" slides-per-view="3" space-between="10" grab-cursor="true">
          <swiper-slide>
            <div class="swipper_el_traders">
              ...
              <div class="swipper_el_traders_content">
                ...
                <div class="grid gap-2">
                  ...
                  <a class="btn m-0 p-2" style="background: linear-gradient(90deg, #3F00F4 0%, #30ACFF 100%);"><svg
