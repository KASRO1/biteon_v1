...
!(function () {
  ...
  (l.WidgetAbstract.prototype = {
    ...
    (l.widget.prototype = {
      ...
      create: function () {
        ...
        this.options.noLogoOverlay ||
          (t = l.WidgetAbstract.prototype.addWrapperFrame.call(this, t)),
          c(t, this.options);
        ...
        o && o.parentElement && o.parentElement.removeChild(o),
          ...
          l.bindEvent(this.iframe, "load", function () {
            e.postMessage.get("widgetReady", {}, function () {
              var t;
              for (e._ready = !0, t = e._ready_handlers.length; t--; )
    ...
    (l.chart.prototype = {
      ...
      create: function () {
        const e = this.render(),
          t = l.WidgetAbstract.prototype.addWrapperFrame.call(this, e);
        var o,
          i = this;
        c(t, this.options),
